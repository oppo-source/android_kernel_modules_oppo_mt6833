...
static unsigned int do_single_lsc_konkatele(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_konkatele(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_konkatele(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_pdaf_konkatele(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static int do_ois_konkatele(struct EEPROM_DRV_FD_DATA *pdata, struct ois_cal_data *data);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	...
	0x00000006, 0x01B1012F, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00001070, 0x0000074C, do_single_lsc_konkatele},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_konkatele}, //Start address, block size is useless
		{0x00000001, 0x000017D0, 0x00001028, do_pdaf_konkatele},
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_konkatele}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT konkatele_op_eeprom = {
	.name = "konkatele_op_eeprom",
	...
	.enable_preload = 1,
	.preload_size = 0x8000,
	.parsing_ois_cal_data_from_preload = do_ois_konkatele,
};
