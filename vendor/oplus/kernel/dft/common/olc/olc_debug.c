            ...
            const char __user *buf, size_t size, loff_t *ppos)
{
    ...
    while (token != NULL)
    {
        if (strncmp(token, "id", strlen("id")) == 0)
        {
            ...
            if (value != NULL)
            {
                if (kstrtouint(value + 1, 16, &exp.exceptionId) < 0)
                {
                    pr_err("olc: invalid param: id\n");
                }
            }
        }
        else if (strncmp(token, "time", strlen("time")) == 0)
        {
            ...
            if (value != NULL)
            {
                if (kstrtoull(value + 1, 10, &exp.time) < 0)
                {
                    pr_err("olc: invalid param: time\n");
                }
            }
        }
        else if (strncmp(token, "level", strlen("level")) == 0)
        {
            ...
            if (value != NULL)
            {
                if (kstrtouint(value + 1, 10, &exp.level) < 0)
                {
                    pr_err("olc: invalid param: level\n");
                }
            }
        }
        else if (strncmp(token, "exceptionType", strlen("exceptionType")) == 0)
        {
            ...
            if (value != NULL)
            {
                if (kstrtouint(value + 1, 10, &exp.exceptionType) < 0)
                {
                    pr_err("olc: invalid param: exceptionType\n");
                }
            }
        }
        else if (strncmp(token, "atomicLogs", strlen("atomicLogs")) == 0)
        {
            ...
            if (value != NULL)
            {
                if (kstrtoull(value + 1, 10, &exp.atomicLogs) < 0)
                {
                    pr_err("olc: invalid param: atomicLogs\n");
                }
            }
        }
