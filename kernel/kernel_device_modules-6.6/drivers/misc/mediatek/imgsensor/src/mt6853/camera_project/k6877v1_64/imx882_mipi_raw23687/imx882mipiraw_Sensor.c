...
static struct SEAMLESS_SYS_DELAY seamless_sys_delays[] = {
    ...
    { MSDK_SCENARIO_ID_CUSTOM7, MSDK_SCENARIO_ID_CUSTOM8, 1 },
    { MSDK_SCENARIO_ID_CUSTOM8, MSDK_SCENARIO_ID_CUSTOM7, 1 },
};
...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case MSDK_SCENARIO_ID_CUSTOM7:
    {
        ...
        FMC_GPH_START;
        imx882_table_write_cmos_sensor(imx882_23687_seamless_custom7, sizeof(imx882_23687_seamless_custom7) / sizeof(kal_uint16));
        if (ae_ctrl) {
    ...
    case MSDK_SCENARIO_ID_CUSTOM8:
    {
        ...
        FMC_GPH_START;
        imx882_table_write_cmos_sensor(imx882_23687_seamless_custom8, sizeof(imx882_23687_seamless_custom8) / sizeof(kal_uint16));
        if (ae_ctrl) {
            LOG_INF("call MSDK_SCENARIO_ID_CUSTOM8 %d %d",
                    ae_ctrl[SHUTTER_NE_FRM_1], ae_ctrl[GAIN_NE_FRM_1]);
