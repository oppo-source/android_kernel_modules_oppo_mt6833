...
#define RG_XO_AAC_FPM_SWEN_ADDR		(DCXO_CW08)
#define RG_XO_AAC_FPM_SWEN_MASK		(0x1)
#define RG_XO_AAC_FPM_SWEN_SHIFT	(15)
#define RG_XO_IDAC_FPM_ADDR		(DCXO_CW10)
#define RG_XO_IDAC_FPM_MASK		(0x3)
#define RG_XO_IDAC_FPM_SHIFT		(9)
#define RG_XO_HEATER_SEL_ADDR		(DCXO_CW11)
...
struct plat_xodata mt6359p_tb_data = {
