...
void mbraink_v6991_get_gnss_lp_data(struct mbraink_gnss2mbr_lp_data *gnss_lp_buffer)
{
...
void mbraink_v6991_get_gnss_mcu_data(struct mbraink_gnss2mbr_mcu_data *gnss_mcu_buffer)
{
	enum gnss2mbr_status ret;
