...
static int mbraink_v6989_memory_getDdrInfo(struct mbraink_memory_ddrInfo *pMemoryDdrInfo)
{
	int ret = 0;
	int i, j;
...
static int mbraink_v6989_memory_getMdvInfo(struct mbraink_memory_mdvInfo  *pMemoryMdv)
{
	int ret = 0;
	int i = 0;
...
static struct mbraink_memory_ops mbraink_v6989_memory_ops = {
	.getDdrInfo = mbraink_v6989_memory_getDdrInfo,
	.getMdvInfo = mbraink_v6989_memory_getMdvInfo,
};

int mbraink_v6989_memory_init(void)
{
	int ret = 0;

	ret = register_mbraink_memory_ops(&mbraink_v6989_memory_ops);
	return ret;
}

int mbraink_v6989_memory_deinit(void)
{
	int ret = 0;
