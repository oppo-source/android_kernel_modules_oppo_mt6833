...
#define CHABERTON_CORE0_CONFIG_REG_STALL_DCM_CONF         (MCUSYS_PAR_WRAP_BASE + 0x180210)
#define MCUSYS_PAR_WRAP_MP0_DCM_CFG0                      (MCUSYS_PAR_WRAP_BASE + 0x27c)
#define CHABERTON_CORE1_CONFIG_REG_STALL_DCM_CONF         (MCUSYS_PAR_WRAP_BASE + 0x190210)
#define CHABERTON_CORE2_CONFIG_REG_STALL_DCM_CONF         (MCUSYS_PAR_WRAP_BASE + 0x1a0210)
#define CHABERTON_CORE3_CONFIG_REG_STALL_DCM_CONF         (MCUSYS_PAR_WRAP_BASE + 0x1b0210)
...
#define VDNR_DCM_TOP_INFRA_PAR_BUS_u_INFRA_PAR_BUS_CTRL_0 (INFRA_AO_BCRM_BASE + 0x28)
#define VDNR_DCM_TOP_INFRA_PAR_BUS_u_INFRA_PAR_BUS_CTRL_1 (INFRA_AO_BCRM_BASE + 0x2c)
#define VDNR_DCM_TOP_INFRA_PAR_BUS_u_INFRA_PAR_BUS_CTRL_2 (INFRA_AO_BCRM_BASE + 0x30)
#define VDNR_DCM_TOP_INFRA_PAR_BUS_u_INFRA_PAR_BUS_CTRL_3 (INFRA_AO_BCRM_BASE + 0x34)
#define VDNR_DCM_TOP_INFRA_PAR_BUS_u_INFRA_PAR_BUS_CTRL_4 (INFRA_AO_BCRM_BASE + 0x38)
#define VDNR_DCM_TOP_INFRA_PAR_BUS_u_INFRA_PAR_BUS_CTRL_5 (INFRA_AO_BCRM_BASE + 0x3c)
#define VDNR_DCM_TOP_INFRA_PAR_BUS_u_INFRA_PAR_BUS_CTRL_6 (INFRA_AO_BCRM_BASE + 0x40)
#define VDNR_DCM_TOP_INFRA_PAR_BUS_u_INFRA_PAR_BUS_CTRL_7 (INFRA_AO_BCRM_BASE + 0x44)
#define VDNR_DCM_TOP_INFRA_PAR_BUS_u_INFRA_PAR_BUS_CTRL_8 (INFRA_AO_BCRM_BASE + 0x48)
#define VDNR_DCM_TOP_INFRA_PAR_BUS_u_INFRA_PAR_BUS_CTRL_9 (INFRA_AO_BCRM_BASE + 0x4c)
#define VDNR_DCM_TOP_PERI_PAR_BUS_u_PERI_PAR_BUS_CTRL_0   (PERI_AO_BCRM_BASE + 0x58)
#define VDNR_DCM_TOP_PERI_PAR_BUS_u_PERI_PAR_BUS_CTRL_1   (PERI_AO_BCRM_BASE + 0x5c)
#define VDNR_DCM_TOP_PERI_PAR_BUS_u_PERI_PAR_BUS_CTRL_2   (PERI_AO_BCRM_BASE + 0x60)
#define VDNR_DCM_TOP_VLP_PAR_BUS_u_VLP_PAR_BUS_CTRL_0     (VLP_AO_BCRM_BASE + 0xa8)
