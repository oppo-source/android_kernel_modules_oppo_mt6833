...
static void ppm_pwrthro_bat_oc_protect(enum BATTERY_OC_LEVEL_TAG level, void *data)
{
	unsigned int limited_power = ~0;
...
void ppm_pwrthro_low_bat_protect(enum LOW_BATTERY_LEVEL_TAG level, void *data)
{
	unsigned int limited_power = ~0;
