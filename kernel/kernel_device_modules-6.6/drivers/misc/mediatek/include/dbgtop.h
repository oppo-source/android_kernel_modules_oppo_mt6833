...
/* dfd_timeout version 1 */
#define MTK_DBGTOP_DFD_TIMEOUT_SHIFT		(0)
#define MTK_DBGTOP_DFD_TIMEOUT_MASK		(0x1FFFFU << MTK_DBGTOP_DFD_TIMEOUT_SHIFT)

/* dfd_timeout version 2 */
#define MTK_DBGTOP_DFD_TIMEOUT_SHIFT_V2		(0)
#define MTK_DBGTOP_DFD_TIMEOUT_MASK_V2		(0x7FFFFU << MTK_DBGTOP_DFD_TIMEOUT_SHIFT_V2)
