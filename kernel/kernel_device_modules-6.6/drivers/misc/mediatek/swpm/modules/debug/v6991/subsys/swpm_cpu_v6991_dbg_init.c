...
int __init swpm_cpu_v6991_dbg_init(void)
{
...
void __exit swpm_cpu_v6991_dbg_exit(void)
{
	swpm_cpu_v6991_exit();
}

module_init(swpm_cpu_v6991_dbg_init);
module_exit(swpm_cpu_v6991_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6991 SWPM cpu debug module");
