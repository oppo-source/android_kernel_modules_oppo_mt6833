...
void __exit swpm_mml_v6991_dbg_exit(void)
{
	swpm_mml_v6991_exit();
}

module_init(swpm_mml_v6991_dbg_init);
module_exit(swpm_mml_v6991_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6991 SWPM mml debug module");
