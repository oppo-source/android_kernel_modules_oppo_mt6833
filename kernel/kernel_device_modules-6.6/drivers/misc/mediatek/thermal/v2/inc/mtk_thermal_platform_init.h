...
extern void  mtk_PA_4G_exit(void);
extern int  mtk_PA_4G_init(void);
extern void  mtk_PA_5G_exit(void);
extern int  mtk_PA_5G_init(void);
extern void  mtk_charger_ts_exit(void);
extern int  mtk_charger_ts_init(void);
extern void  mtk_sub_bat_exit(void);
extern int  mtk_sub_bat_init(void);
...
extern void mtk_tscharger_init(void);
extern int mtk_tscharger_exit(void);
