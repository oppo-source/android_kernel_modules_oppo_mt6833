...
static int mtk_PA_4G_register_thermal(void)
{
	...
	/* trips : trip 0~1 */
	thz_dev = mtk_thermal_zone_device_register("PA_4G_tmp", trips, num_trip,
...
#define THERMAL_THERMISTOR_NAME    "mtboard-thermistor2-tacoo"
