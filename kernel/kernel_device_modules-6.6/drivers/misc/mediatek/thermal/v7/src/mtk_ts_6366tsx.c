...
static long mt6366tsx_cur_temp;
/*
...
static int mt6366tsx_change_mode
...
static struct thermal_zone_device_ops mt6366tsx_dev_ops = {
	...
	.change_mode = mt6366tsx_change_mode,
...
static const struct proc_ops mt6366tsx_fops = {
	.proc_open = mt6366tsx_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_write = mt6366tsx_write,
	.proc_release = single_release,
};

static int mt6366tsx_probe(struct platform_device *pdev)
{
	int err = 0;
	...
	if (!mt6366tsx_dir) {
		...
		entry =
		    proc_create("tz6359tsx", 664, mt6366tsx_dir,
				&mt6366tsx_fops);
		if (entry)
...
static const struct of_device_id mt6366tsx_of_match[] = {
		{.compatible = "mediatek,mt6366tsx",},
		{},
};
MODULE_DEVICE_TABLE(of, mt6366tsx_of_match);
static struct platform_driver mt6366tsx_driver = {
		.probe = mt6366tsx_probe,
		.driver = {
			.name = "mt6366tsx",
			.of_match_table = mt6366tsx_of_match,
		},
};

int mt6366tsx_init(void)
{
	platform_driver_register(&mt6366tsx_driver);
	return 0;
}

void mt6366tsx_exit(void)
{
	mt6366tsx_unregister_thermal();
	mt6366tsx_unregister_cooler();
	mtkTTimer_unregister("mt6366tsx");
	platform_driver_unregister(&mt6366tsx_driver);
}
