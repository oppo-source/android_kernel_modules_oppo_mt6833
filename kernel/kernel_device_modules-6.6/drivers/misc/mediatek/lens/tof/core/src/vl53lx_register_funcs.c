...
VL53LX_Error VL53LX_i2c_encode_static_config(
	struct VL53LX_static_config_t   *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_general_config(
	struct VL53LX_general_config_t  *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_timing_config(
	struct VL53LX_timing_config_t   *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_dynamic_config(
	struct VL53LX_dynamic_config_t  *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
	...
	*(pbuffer +   0) =
	...
	VL53LX_i2c_encode_uint16_t(
		...
		pbuffer +   3);
	*(pbuffer +   5) =
		pdata->system__enable_xtalk_per_quad & 0x1;
	*(pbuffer +   6) =
	...
	struct VL53LX_dynamic_config_t   *pdata)
{
	...
	pdata->system__enable_xtalk_per_quad =
		(*(pbuffer +   5)) & 0x1;
...
VL53LX_Error VL53LX_i2c_encode_system_control(
	struct VL53LX_system_control_t  *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_core_results(
	struct VL53LX_core_results_t    *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_debug_results(
	struct VL53LX_debug_results_t   *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
	...
	*(pbuffer +  17) =
	...
	VL53LX_i2c_encode_uint16_t(
		...
		pbuffer +  24);
	*(pbuffer +  26) =
		pdata->gph__system__enable_xtalk_per_quad & 0x1;
	*(pbuffer +  27) =
	...
	struct VL53LX_debug_results_t    *pdata)
{
	...
	pdata->gph__system__thresh_low =
		(VL53LX_i2c_decode_uint16_t(2, pbuffer +  24));
	pdata->gph__system__enable_xtalk_per_quad =
		(*(pbuffer +  26)) & 0x1;
	pdata->gph__spare_0 =
		(*(pbuffer +  27)) & 0x7;
	pdata->gph__sd_config__woi_sd0 =
...
VL53LX_Error VL53LX_i2c_encode_prev_shadow_system_results(
	struct VL53LX_prev_shadow_system_results_t *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_prev_shadow_core_results(
	struct VL53LX_prev_shadow_core_results_t *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_patch_debug(
	struct VL53LX_patch_debug_t     *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_gph_general_config(
	struct VL53LX_gph_general_config_t *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_gph_static_config(
	struct VL53LX_gph_static_config_t *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_gph_timing_config(
	struct VL53LX_gph_timing_config_t *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_fw_internal(
	struct VL53LX_fw_internal_t     *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_patch_results(
	struct VL53LX_patch_results_t   *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_shadow_system_results(
	struct VL53LX_shadow_system_results_t *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
...
VL53LX_Error VL53LX_i2c_encode_shadow_core_results(
	struct VL53LX_shadow_core_results_t *pdata,
	uint16_t                  buf_size,
	uint8_t                  *pbuffer)
{
