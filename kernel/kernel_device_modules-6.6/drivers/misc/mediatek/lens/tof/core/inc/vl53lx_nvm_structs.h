...
struct VL53LX_decoded_nvm_data_t {
	...
	struct VL53LX_optical_centre_t              fmt_optical_centre;
	struct VL53LX_cal_peak_rate_map_t           fmt_peak_rate_map;
	struct VL53LX_additional_offset_cal_data_t  fmt_add_offset_data;

	struct VL53LX_decoded_nvm_fmt_range_data_t
		fmt_range_data[VL53LX_NVM_MAX_FMT_RANGE_DATA];

	struct VL53LX_decoded_nvm_fmt_info_t        fmt_info;
	struct VL53LX_decoded_nvm_ews_info_t        ews_info;
