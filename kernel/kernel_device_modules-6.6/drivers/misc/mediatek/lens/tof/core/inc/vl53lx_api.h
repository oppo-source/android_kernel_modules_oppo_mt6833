 ...
 * @return  "Other error code"    See ::VL53LX_Error
 */
VL53LX_Error VL53LX_SetDeviceAddress(struct VL53LX_Dev_t *Dev,
...
VL53LX_Error VL53LX_SetMeasurementTimingBudgetMicroSeconds(
	struct VL53LX_Dev_t *Dev, uint32_t MeasurementTimingBudgetMicroSeconds);
...
VL53LX_Error VL53LX_GetMeasurementTimingBudgetMicroSeconds(
	struct VL53LX_Dev_t *Dev, uint32_t *pMeasurementTimingBudgetMicroSeconds);
...
VL53LX_Error VL53LX_SetUserROI(struct VL53LX_Dev_t *Dev,
		struct VL53LX_UserRoi_t *pUserROi);
