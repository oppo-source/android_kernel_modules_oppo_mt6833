...
VL53LX_Error VL53LX_f_025(
	...
	struct VL53LX_hist_gen3_algo_private_data_t   *palgo3,
	...
	uint8_t                                histo_merge_nb)
{
	...
	struct VL53LX_hist_pulse_data_t     *ppulse_data;
	struct VL53LX_range_data_t          *prange_data;

	uint8_t                       p = 0;
	struct VL53LX_histogram_bin_data_t *pB = &(palgo3->VL53LX_p_006);
	...
	struct VL53LX_hist_gen4_algo_filtered_data_t *pfiltered)
{
	...
	struct VL53LX_hist_pulse_data_t *pdata = &(palgo3->VL53LX_p_003[pulse_no]);
