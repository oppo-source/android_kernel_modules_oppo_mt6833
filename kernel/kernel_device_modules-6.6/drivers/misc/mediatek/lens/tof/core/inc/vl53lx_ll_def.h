...
struct VL53LX_zone_config_t {
	...
	struct VL53LX_histogram_config_t multizone_hist_cfg;

	struct VL53LX_user_zone_t user_zones[VL53LX_MAX_USER_ZONES];
...
struct VL53LX_range_results_t {
	...
	struct VL53LX_range_data_t    VL53LX_p_003[VL53LX_MAX_RANGE_RESULTS];

	struct VL53LX_range_data_t    xmonitor;

	struct VL53LX_smudge_corrector_data_t smudge_corrector_data;
};
...
struct VL53LX_xtalk_range_results_t {
	...
	struct VL53LX_histogram_bin_data_t central_histogram_sum;

	struct VL53LX_histogram_bin_data_t central_histogram_avg;
...
struct VL53LX_zone_objects_t {
	...
	struct VL53LX_object_data_t   VL53LX_p_003[VL53LX_MAX_RANGE_RESULTS];


	struct VL53LX_object_data_t   xmonitor;
};
...
struct VL53LX_zone_results_t {
	...
	struct VL53LX_zone_objects_t VL53LX_p_003[VL53LX_MAX_USER_ZONES];
};
...
struct VL53LX_zone_histograms_t {
	...
	struct VL53LX_zone_hist_info_t     VL53LX_p_003[VL53LX_MAX_USER_ZONES];
...
struct VL53LX_zone_calibration_results_t {
	...
	struct VL53LX_zone_calibration_data_t   VL53LX_p_003[VL53LX_MAX_USER_ZONES];
...
struct VL53LX_zone_private_dyn_cfgs_t {
	...
	struct VL53LX_zone_private_dyn_cfg_t VL53LX_p_003[VL53LX_MAX_USER_ZONES];
...
struct VL53LX_LLDriverData_t {
	...
	struct VL53LX_ll_version_t                 version;


	struct VL53LX_ll_driver_state_t            ll_state;


	struct VL53LX_GPIO_interrupt_config_t	    gpio_interrupt_config;


	struct VL53LX_customer_nvm_managed_t       customer;
	struct VL53LX_cal_peak_rate_map_t          cal_peak_rate_map;
	struct VL53LX_additional_offset_cal_data_t add_off_cal_data;
	struct VL53LX_dmax_calibration_data_t      fmt_dmax_cal;
	struct VL53LX_dmax_calibration_data_t      cust_dmax_cal;
	struct VL53LX_gain_calibration_data_t      gain_cal;
	struct VL53LX_user_zone_t                  mm_roi;
	struct VL53LX_optical_centre_t             optical_centre;
	struct VL53LX_zone_config_t                zone_cfg;


	struct VL53LX_tuning_parm_storage_t        tuning_parms;


	uint8_t rtn_good_spads[VL53LX_RTN_SPAD_BUFFER_SIZE];


	struct VL53LX_refspadchar_config_t         refspadchar;
	struct VL53LX_ssc_config_t                 ssc_cfg;
	struct VL53LX_hist_post_process_config_t   histpostprocess;
	struct VL53LX_hist_gen3_dmax_config_t      dmax_cfg;
	struct VL53LX_xtalkextract_config_t        xtalk_extract_cfg;
	struct VL53LX_xtalk_config_t               xtalk_cfg;
	struct VL53LX_offsetcal_config_t           offsetcal_cfg;
	struct VL53LX_zonecal_config_t             zonecal_cfg;


	struct VL53LX_static_nvm_managed_t         stat_nvm;
	struct VL53LX_histogram_config_t           hist_cfg;
	struct VL53LX_static_config_t              stat_cfg;
	struct VL53LX_general_config_t             gen_cfg;
	struct VL53LX_timing_config_t              tim_cfg;
	struct VL53LX_dynamic_config_t             dyn_cfg;
	struct VL53LX_system_control_t             sys_ctrl;
	struct VL53LX_system_results_t             sys_results;
	struct VL53LX_nvm_copy_data_t              nvm_copy_data;


	struct VL53LX_histogram_bin_data_t         hist_data;
	struct VL53LX_histogram_bin_data_t         hist_xtalk;


	struct VL53LX_xtalk_histogram_data_t       xtalk_shapes;
	struct VL53LX_xtalk_range_results_t        xtalk_results;
	struct VL53LX_xtalk_calibration_results_t  xtalk_cal;
	struct VL53LX_hist_xtalk_extract_data_t    xtalk_extract;


	struct VL53LX_offset_range_results_t       offset_results;


	struct VL53LX_core_results_t               core_results;
	struct VL53LX_debug_results_t              dbg_results;

	struct VL53LX_smudge_corrector_config_t	smudge_correct_config;

	struct VL53LX_smudge_corrector_internals_t smudge_corrector_internals;




	struct VL53LX_low_power_auto_data_t		low_power_auto_data;
...
struct VL53LX_LLDriverResults_t {
	...
	struct VL53LX_range_results_t             range_results;


	struct VL53LX_zone_private_dyn_cfgs_t     zone_dyn_cfgs;


	struct VL53LX_zone_results_t              zone_results;
	struct VL53LX_zone_histograms_t           zone_hists;
	struct VL53LX_zone_calibration_results_t  zone_cal;
...
#define VL53LX_COPYSTRING(str, ...) \
	(strscpy(str, ##__VA_ARGS__, VL53LX_MAX_STRING_LENGTH-1))
