...
static struct cmdq_event_table cmdq_events[] = {
	...
	DECLAR_EVENT(CMDQ_EVENT_DIP_CQ_THREAD3_EOF, dip-cq-thread3-frame-done)
	DECLAR_EVENT(CMDQ_EVENT_DIP_CQ_THREAD4_EOF, dip-cq-thread4-frame-done)
	DECLAR_EVENT(CMDQ_EVENT_DIP_CQ_THREAD5_EOF, dip-cq-thread5-frame-done)
	DECLAR_EVENT(CMDQ_EVENT_DIP_CQ_THREAD6_EOF, dip-cq-thread6-frame-done)
