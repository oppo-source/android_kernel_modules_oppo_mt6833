...
/****************************************************************************
 *  Type Definitionsbase driver. in file name
 ****************************************************************************/
...
#endif /* CONFIG_MTK_TINYSYS_SSPM_SUPPORT : 573 */
...
EXPORT_SYMBOL(swpm_set_update_cnt);
...
module_init(swpm_platform_init)
