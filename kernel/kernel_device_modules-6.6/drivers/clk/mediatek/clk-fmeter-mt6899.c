...
const char *comp_list[] = {
	[FM_TOPCKGEN] = "mediatek,mt6899-topckgen",
	[FM_APMIXEDSYS] = "mediatek,mt6899-apmixedsys",
	[FM_VLP_CKSYS] = "mediatek,mt6899-vlp_cksys",
	[FM_MFGPLL] = "mediatek,mt6899-mfgpll_pll_ctrl",
	[FM_MFGSCPLL] = "mediatek,mt6899-mfgscpll_pll_ctrl",
	[FM_ARMPLL_LL] = "mediatek,mt6899-armpll_ll_pll_ctrl",
	[FM_ARMPLL_BL] = "mediatek,mt6899-armpll_bl_pll_ctrl",
	[FM_ARMPLL_B] = "mediatek,mt6899-armpll_b_pll_ctrl",
	[FM_CCIPLL] = "mediatek,mt6899-ccipll_pll_ctrl",
	[FM_PTPPLL] = "mediatek,mt6899-ptppll_pll_ctrl",
};
...
static const struct fmeter_clk fclks[] = {
	...
	FMCLK2(CKGEN, FM_MCU_ACP_CK, "fm_mcu_acp_ck", 0x0050, 31, 1),
	FMCLK2(CKGEN, FM_TL_CK, "fm_tl_ck", 0x0060, 7, 1),
	FMCLK2(CKGEN, FM_EMI_INTERFACE_546_CK, "fm_emi_interface_546_ck", 0x0060, 15, 1),
	FMCLK2(CKGEN, FM_DSP_CK, "fm_dsp_ck", 0x0060, 23, 1),
	FMCLK2(CKGEN, FM_MFG_REF_CK, "fm_mfg_ref_ck", 0x0060, 31, 1),
	FMCLK2(CKGEN, FM_MFGSC_REF_CK, "fm_mfgsc_ref_ck", 0x0070, 7, 1),
	FMCLK2(CKGEN, FM_MFG_EB_CK, "fm_mfg_eb_ck", 0x0070, 15, 1),
	FMCLK2(CKGEN, FM_UART_CK, "fm_uart_ck", 0x0070, 23, 1),
	FMCLK2(CKGEN, FM_SPI0_B_CK, "fm_spi0_b_ck", 0x0070, 31, 1),
	FMCLK2(CKGEN, FM_SPI1_B_CK, "fm_spi1_b_ck", 0x0080, 7, 1),
	FMCLK2(CKGEN, FM_SPI2_B_CK, "fm_spi2_b_ck", 0x0080, 15, 1),
	FMCLK2(CKGEN, FM_SPI3_B_CK, "fm_spi3_b_ck", 0x0080, 23, 1),
	FMCLK2(CKGEN, FM_SPI4_B_CK, "fm_spi4_b_ck", 0x0080, 31, 1),
	FMCLK2(CKGEN, FM_SPI5_B_CK, "fm_spi5_b_ck", 0x0090, 7, 1),
	FMCLK2(CKGEN, FM_SPI6_B_CK, "fm_spi6_b_ck", 0x0090, 15, 1),
	FMCLK2(CKGEN, FM_SPI7_B_CK, "fm_spi7_b_ck", 0x0090, 23, 1),
	FMCLK2(CKGEN, FM_MSDC_MACRO_1P_CK, "fm_msdc_macro_1p_ck", 0x0090, 31, 1),
	FMCLK2(CKGEN, FM_MSDC_MACRO_2P_CK, "fm_msdc_macro_2p_ck", 0x00A0, 7, 1),
	FMCLK2(CKGEN, FM_MSDC30_1_CK, "fm_msdc30_1_ck", 0x00A0, 15, 1),
	FMCLK2(CKGEN, FM_MSDC30_2_CK, "fm_msdc30_2_ck", 0x00A0, 23, 1),
	FMCLK2(CKGEN, FM_AUD_INTBUS_CK, "fm_aud_intbus_ck", 0x00A0, 31, 1),
	...
	FMCLK2(CKGEN, FM_MSDC30_1_H_CK, "fm_msdc30_1_h_ck", 0x00B0, 31, 1),
	FMCLK2(CKGEN, FM_I2C_CK, "fm_i2c_ck", 0x00C0, 7, 1),
	FMCLK2(CKGEN, FM_AUD_ENGEN1_CK, "fm_aud_engen1_ck", 0x00C0, 15, 1),
	FMCLK2(CKGEN, FM_AUD_ENGEN2_CK, "fm_aud_engen2_ck", 0x00C0, 23, 1),
	FMCLK2(CKGEN, FM_AES_UFSFDE_CK, "fm_aes_ufsfde_ck", 0x00C0, 31, 1),
	FMCLK2(CKGEN, FM_U_CK, "fm_u_ck", 0x00D0, 7, 1),
	FMCLK2(CKGEN, FM_U_MBIST_CK, "fm_u_mbist_ck", 0x00D0, 15, 1),
	FMCLK2(CKGEN, FM_PEXTP_MBIST_CK, "fm_pextp_mbist_ck", 0x00D0, 23, 1),
	FMCLK2(CKGEN, FM_AUD_1_CK, "fm_aud_1_ck", 0x00D0, 31, 1),
	FMCLK2(CKGEN, FM_AUD_2_CK, "fm_aud_2_ck", 0x00E0, 7, 1),
	FMCLK2(CKGEN, FM_AUDIO_H_CK, "fm_audio_h_ck", 0x00E0, 15, 1),
	FMCLK2(CKGEN, FM_ADSP_CK, "fm_adsp_ck", 0x00E0, 23, 1),
	FMCLK2(CKGEN, FM_ADPS_UARTHUB_B_CK, "fm_adps_uarthub_b_ck", 0x00E0, 31, 1),
	...
	FMCLK2(CKGEN, FM_SDF_CK, "fm_sdf_ck", 0x00F0, 31, 1),
	FMCLK2(CKGEN, FM_UARTHUB_B_CK, "fm_uarthub_b_ck", 0x0100, 7, 1),
	FMCLK2(CKGEN, FM_SSR_PKA_CK, "fm_ssr_pka_ck", 0x0100, 15, 1),
	FMCLK2(CKGEN, FM_SSR_DMA_CK, "fm_ssr_dma_ck", 0x0100, 23, 1),
	FMCLK2(CKGEN, FM_SSR_KDF_CK, "fm_ssr_kdf_ck", 0x0100, 31, 1),
	FMCLK2(CKGEN, FM_SSR_RNG_CK, "fm_ssr_rng_ck", 0x0110, 7, 1),
	FMCLK2(CKGEN, FM_DXCC_CK, "fm_dxcc_ck", 0x0110, 15, 1),
	FMCLK2(CKGEN, FM_DPSW_CMP_26M_CK, "fm_dpsw_cmp_26m_ck", 0x0110, 23, 1),
	FMCLK2(CKGEN, FM_SMAPCK_CK, "fm_smapck_ck", 0x0110, 31, 1),
	FMCLK2(CKGEN, FM_MSDC30_2_H_CK, "fm_msdc30_2_h_ck", 0x0120, 23, 1),
	/* ABIST Part */
	...
	FMCLK(ABIST, FM_MDPLL1_FS26M_R_CK, "fm_mdpll1_fs26m_r_ck", 1),
	...
	/* CKGEN_CK2 Part */
	FMCLK2(CKGEN_CK2, FM_SENINF0_CK, "fm_seninf0_ck", 0x0810, 7, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF1_CK, "fm_seninf1_ck", 0x0810, 15, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF2_CK, "fm_seninf2_ck", 0x0810, 23, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF3_CK, "fm_seninf3_ck", 0x0810, 31, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF4_CK, "fm_seninf4_ck", 0x0820, 7, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF5_CK, "fm_seninf5_ck", 0x0820, 15, 1),
	FMCLK2(CKGEN_CK2, FM_CCU_AHB_CK, "fm_ccu_ahb_ck", 0x0820, 23, 1),
	FMCLK2(CKGEN_CK2, FM_IMG1_CK, "fm_img1_ck", 0x0820, 31, 1),
	FMCLK2(CKGEN_CK2, FM_IPE_CK, "fm_ipe_ck", 0x0830, 7, 1),
	FMCLK2(CKGEN_CK2, FM_CAM_CK, "fm_cam_ck", 0x0830, 15, 1),
	FMCLK2(CKGEN_CK2, FM_CAMTM_CK, "fm_camtm_ck", 0x0830, 23, 1),
	FMCLK2(CKGEN_CK2, FM_DPE_CK, "fm_dpe_ck", 0x0830, 31, 1),
	FMCLK2(CKGEN_CK2, FM_VDEC_CK, "fm_vdec_ck", 0x0840, 7, 1),
	FMCLK2(CKGEN_CK2, FM_CCUSYS_CK, "fm_ccusys_ck", 0x0840, 15, 1),
	FMCLK2(CKGEN_CK2, FM_CCUTM_CK, "fm_ccutm_ck", 0x0840, 23, 1),
	FMCLK2(CKGEN_CK2, FM_VENC_CK, "fm_venc_ck", 0x0840, 31, 1),
	FMCLK2(CKGEN_CK2, FM_DP_CORE_CK, "fm_dp_core_ck", 0x0850, 7, 1),
	FMCLK2(CKGEN_CK2, FM_DP_CK, "fm_dp_ck", 0x0850, 15, 1),
	FMCLK2(CKGEN_CK2, FM_DISP_CK, "fm_disp_ck", 0x0850, 23, 1),
	FMCLK2(CKGEN_CK2, FM_MDP_CK, "fm_mdp_ck", 0x0850, 31, 1),
	FMCLK2(CKGEN_CK2, FM_MMINFRA_CK, "fm_mminfra_ck", 0x0860, 7, 1),
	FMCLK2(CKGEN_CK2, FM_MMUP_CK, "fm_mmup_ck", 0x0860, 15, 1),
	FMCLK2(CKGEN_CK2, FM_IMG_26M_CK, "fm_img_26m_ck", 0x0870, 7, 1),
	FMCLK2(CKGEN_CK2, FM_CAM_26M_CK, "fm_cam_26m_ck", 0x0870, 15, 1),
	/* ABIST_CK2 Part */
	FMCLK(ABIST_CK2, FM_MAINPLL_TST_CK, "fm_mainpll_tst_ck", 1),
	FMCLK(ABIST_CK2, FM_UNIVPLL_TST_CK, "fm_univpll_tst_ck", 1),
	FMCLK(ABIST_CK2, FM_MMPLL_TST_CK, "fm_mmpll_tst_ck", 1),
	FMCLK(ABIST_CK2, FM_MSDCPLL_TST_CK, "fm_msdcpll_tst_ck", 1),
	FMCLK(ABIST_CK2, FM_ADSPPLL_TST_CK, "fm_adsppll_tst_ck", 1),
	FMCLK3(ABIST_CK2, FM_TVDPLL_CKDIV_CK, "fm_tvdpll_ckdiv_ck", 0x024c, 3, 13),
	FMCLK(ABIST_CK2, FM_APLL1_TST_CK, "fm_apll1_tst_ck", 1),
	FMCLK(ABIST_CK2, FM_APLL2_TST_CK, "fm_apll2_tst_ck", 1),
	FMCLK(ABIST_CK2, FM_EMIPLL_TST_CK, "fm_emipll_tst_ck", 1),
	FMCLK(ABIST_CK2, FM_EMIPLL2_TST_CK, "fm_emipll2_tst_ck", 1),
	...
	FMCLK2(VLPCK, FM_SPMI_M_TIA_CK, "fm_spmi_m_tia_ck", 0x0020, 23, 1),
	...
	FMCLK2(VLPCK, FM_SPMI_P_CK, "fm_spmi_p_ck", 0x0050, 15, 1),
	...
	FMCLK2(VLPCK, FM_CAMTG0_CK, "fm_camtg0_ck", 0x0060, 15, 1),
	FMCLK2(VLPCK, FM_CAMTG1_CK, "fm_camtg1_ck", 0x0060, 23, 1),
	FMCLK2(VLPCK, FM_CAMTG2_CK, "fm_camtg2_ck", 0x0060, 31, 1),
	FMCLK2(VLPCK, FM_CAMTG3_CK, "fm_camtg3_ck", 0x0070, 7, 1),
	FMCLK2(VLPCK, FM_CAMTG4_CK, "fm_camtg4_ck", 0x0070, 15, 1),
	FMCLK2(VLPCK, FM_CAMTG5_CK, "fm_camtg5_ck", 0x0070, 23, 1),
	FMCLK2(VLPCK, FM_CAMTG6_CK, "fm_camtg6_ck", 0x0070, 31, 1),
	FMCLK2(VLPCK, FM_CAMTG7_CK, "fm_camtg7_ck", 0x0080, 7, 1),
	FMCLK2(VLPCK, FM_DPSW_CENTRAL_CK, "fm_dpsw_central_ck", 0x0080, 15, 1),
	FMCLK2(VLPCK, FM_TOPRGU_26M_CK, "fm_toprgu_26m_ck", 0x0080, 23, 1),
...
const struct fmeter_clk *mt6899_get_fmeter_clks(void)
{
	return fclks;
}
...
static unsigned int mt6899_get_ckgen_freq(unsigned int ID)
{
	return __mt_get_freq(ID, CKGEN);
}

static unsigned int mt6899_get_abist_freq(unsigned int ID)
{
	return __mt_get_freq(ID, ABIST);
}

static unsigned int mt6899_get_ckgen_ck2_freq(unsigned int ID)
{
	return __mt_get_freq_ck2(ID, CKGEN_CK2);
}

static unsigned int mt6899_get_abist_ck2_freq(unsigned int ID)
{
	return __mt_get_freq_ck2(ID, ABIST_CK2);
}

static unsigned int mt6899_get_vlpck_freq(unsigned int ID)
{
	return __mt_get_freq2(FM_VLP_CKSYS, ID);
}

static unsigned int mt6899_get_subsys_freq(unsigned int ID)
{
	int output = 0;
	unsigned long flags;
...
static unsigned int mt6899_get_fmeter_freq(unsigned int id,
		enum FMETER_TYPE type)
{
	if (type == CKGEN)
		return mt6899_get_ckgen_freq(id);
	else if (type == ABIST)
		return mt6899_get_abist_freq(id);
	else if (type == CKGEN_CK2)
		return mt6899_get_ckgen_ck2_freq(id);
	else if (type == ABIST_CK2)
		return mt6899_get_abist_ck2_freq(id);
	else if (type == SUBSYS)
		return mt6899_get_subsys_freq(id);
	else if (type == VLPCK)
		return mt6899_get_vlpck_freq(id);
...
static int mt6899_get_fmeter_id(enum FMETER_ID fid)
{
	if (fid == FID_DISP_PWM)
...
static struct fmeter_ops fm_ops = {
	.get_fmeter_clks = mt6899_get_fmeter_clks,
	.get_fmeter_freq = mt6899_get_fmeter_freq,
	.get_fmeter_id = mt6899_get_fmeter_id,
};

static int clk_fmeter_mt6899_probe(struct platform_device *pdev)
{
	int i;
...
static struct platform_driver clk_fmeter_mt6899_drv = {
	.probe = clk_fmeter_mt6899_probe,
	.driver = {
		.name = "clk-fmeter-mt6899",
		.owner = THIS_MODULE,
	},
};
...
static int __init clk_fmeter_init(void)
{
	...
	clk_fmeter_dev = platform_device_register_simple("clk-fmeter-mt6899", -1, NULL, 0);
	if (IS_ERR(clk_fmeter_dev))
		pr_warn("unable to register clk-fmeter device");

	return platform_driver_register(&clk_fmeter_mt6899_drv);
}
