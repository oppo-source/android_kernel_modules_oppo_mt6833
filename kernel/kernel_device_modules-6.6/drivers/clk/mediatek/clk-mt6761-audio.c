...
static int clk_mt6761_audio_probe(struct platform_device *pdev)
{
...
static const struct of_device_id of_match_clk_mt6761_audio[] = {
	{ .compatible = "mediatek,mt6761-audsys", },
	{}
};
