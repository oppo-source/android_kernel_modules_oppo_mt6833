...
#ifndef tpd1_CUSTOM_GT9XX_H__
#define tpd1_CUSTOM_GT9XX_H__
...
extern unsigned int tpd1_rst_gpio_number;
extern unsigned int tpd1_int_gpio_number;
...
/* #define tpd1_HAVE_BUTTON*/    /*report key as coordinate,Vibration feedback *//*config in  dts file */
/* #define tpd1_WARP_X *//*config in defconfig*/
/* #define tpd1_WARP_Y *//*config in defconfig*/
...
#define tpd1_VELOCITY_CUSTOM_X 15
#define tpd1_VELOCITY_CUSTOM_Y 15
...
#define GT91XX_CONFIG_PROC_FILE     "lcm_config"
...
#endif
#define tpd1_KEY_COUNT           				5    				//  4
#define tpd1_KEYS                					{KEY_KATAKANAHIRAGANA, KEY_YEN, KEY_RO, KEY_HANGEUL,KEY_F12}
...
#define tpd1_I2C_NUMBER				  0
#define I2C_MASTER_CLOCK              300
#define MAX_I2C_TRANSFER_SIZE         (MAX_TRANSACTION_LENGTH - GTP_ADDR_LENGTH)
#define tpd1_MAX_RESET_COUNT           3
/* #define tpd1_CALIBRATION_MATRIX        {962,0,0,0,1600,0,0,0} */
#define tpd1_CALIBRATION_MATRIX_ROTATION_NORMAL {0, 2559, 0, -6557, 0, 5238784, 0, 0}
#define tpd1_CALIBRATION_MATRIX_ROTATION_FACTORY {0, 2559, 0, -6557, 0, 5238784, 0, 0}


#define tpd1_RESET_ISSUE_WORKAROUND
#define tpd1_HAVE_CALIBRATION
#define tpd1_NO_GPIO
#define tpd1_RESET_ISSUE_WORKAROUND
...
#ifdef tpd1_WARP_X
#undef tpd1_WARP_X
#define tpd1_WARP_X(x_max, x) (x_max - 1 - x)
#else
#define tpd1_WARP_X(x_max, x) x
#endif

#ifdef tpd1_WARP_Y
#undef tpd1_WARP_Y
#define tpd1_WARP_Y(y_max, y) (y_max - 1 - y)
#else
#define tpd1_WARP_Y(y_max, y) y
#endif
