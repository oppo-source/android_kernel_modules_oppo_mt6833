...
EXPORT_SYMBOL(mt6853_enable_dc_compensation);
...
EXPORT_SYMBOL(mt6853_set_lch_dc_compensation);
...
EXPORT_SYMBOL(mt6853_set_rch_dc_compensation);
...
EXPORT_SYMBOL(mt6853_adda_dl_gain_control);
