		      ...
		      struct snd_soc_dai *dai)
{
	...
	case SNDRV_PCM_TRIGGER_RESUME:
		mtk_memif_set_pbuf_size(afe, id, MT6899_MEMIF_PBUF_SIZE_256_BYTES);
		mtk_memif_set_min_max_len(afe, id, MT6899_MEMIF_MIN_LEN_64_BYTES,
					  MT6899_MEMIF_MAX_LEN_64_BYTES);
