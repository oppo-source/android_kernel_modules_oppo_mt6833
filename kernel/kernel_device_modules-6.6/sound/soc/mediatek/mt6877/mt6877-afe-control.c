...
EXPORT_SYMBOL(mt6877_enable_dc_compensation);
...
EXPORT_SYMBOL(mt6877_set_lch_dc_compensation);
...
EXPORT_SYMBOL(mt6877_set_rch_dc_compensation);
...
EXPORT_SYMBOL(mt6877_adda_dl_gain_control);
